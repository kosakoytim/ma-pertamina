...
//            mAuthTask.execute((Void) null);
            ...
            apiService.login(username, password,"pangkalan").enqueue(new Callback<LoginResponse>() {
                @Override
                public void onResponse(Call<LoginResponse> call, Response<LoginResponse> response) {
                    SharedPreferences pref = getSharedPreferences("PERTAMINA", Context.MODE_PRIVATE);
